...
const en: TranslationDictionary = {
  ...
  desktopWindow: {
    ...
    toggleToolMode: "Toggle tool mode",
    installAgents: "Install Agents",
    mcpTools: "MCP Tools",
    minimize: "Minimize",
    maximize: "Maximize",
  ...
  featureExplorer: {
    ...
    workViewLabel: "Browse View",
    sectionView: "Capabilities",
    browserUrlView: "Surfaces",
    apiView: "APIs",
    pathView: "Paths",
    ...
    generateModeAgent: "Agent",
    generateModeQuickScan: "Quick scan",
    generateModeAgentDescription: "Default mode. Launch a specialist, show the live session, then commit the returned metadata to the feature tree.",
    generateModeQuickScanDescription: "Fallback mode. Skip the specialist and generate directly from deterministic repository scans.",
    generateWithAgentAction: "Generate with agent",
    dryRunLabel: "Preview only",
    dryRunDescription: "Preview what will be generated without writing files.",
    generateAction: "Generate",
    generating: "Generating…",
    applyingAgentResult: "Applying agent result…",
    ...
    preflightPending: "Loading repository preflight…",
    scanRootLabel: "Scan root",
    adaptersLabel: "Adapters",
    candidateRootsLabel: "Candidate roots",
    agentLogsTitle: "Agent session",
    agentLogsDescription: "The specialist session and tool activity stream here while generation is running.",
    agentLogsEmpty: "Start agent generation to inspect the live reasoning and tool-call process.",
    quickScanIdleTitle: "Quick scan ready",
    quickScanIdleDescription: "Run the deterministic generator directly when you do not need specialist reasoning or logs.",
    previewMode: "Preview",
  ...
  workspace: {
    ...
    confirmDelete: "Are you sure you want to delete this workspace? This action cannot be undone.",
